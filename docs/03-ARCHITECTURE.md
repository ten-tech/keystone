...
**287 tests au total** dans le workspace principal — `ks-ui` vit dans un workspace séparé et porte les siens (42), tous portables et tous exécutés — `cargo test --workspace`,
