...
4. **Widget de bureau / barre des tâches** — **tranché** : une icône d'état, trois tenues, aucun décompte, aucune notification, aucune animation. Voir [ADR-0019](adr/0019-le-widget-de-la-zone-de-notification.md). La question est restée ouverte des semaines pour une bonne raison : jusqu'au lot 6 de la Phase 1, l'anneau répondait « pas encore calculable », et concevoir un indicateur permanent pour une valeur qui n'existe pas revient à concevoir sa décoration.
5. **Vue mobile en lecture seule** — consulter l'état de son poste depuis son téléphone, avec un unique bouton d'action : *Isoler la machine*. C'est l'exigence D16-05, que la [feuille de route](07-FEUILLE-DE-ROUTE.md) place en **phase 6**, avec l'essaimage. Ce point disait « à maquetter en phase 2 » : quatre phases avant la livraison, pour une maquette qui aurait vieilli sans rien à valider. La feuille de route fait foi sur le séquencement.
